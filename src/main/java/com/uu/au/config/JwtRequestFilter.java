...
public class JwtRequestFilter extends OncePerRequestFilter {
    ...
    private static final List<String> ok = List.of("/autoclose", "/su", "/login/cas", "/consume-token", "/auth", "/authDemo", "/secured", "/unregistered", "/unsuccessful", "/populateDB", "/error", "/", "/webhook/github/accept", "/restart");
